...
<form action="#" class="font-size-16 font-rale d-flex justify-content-end mr-5 mb-5" style="position: fixed; right: 0; bottom: 0; z-index: 100;">
  ...
  <span class="d-flex justify-content-center rounded-circle text-white bg-dark font-size-12" style="width: 20px; height: 20px; position: absolute;"><?php echo count($Cart->getDataCart('carts')); ?></span>
</form>
<!-- !chart button -->